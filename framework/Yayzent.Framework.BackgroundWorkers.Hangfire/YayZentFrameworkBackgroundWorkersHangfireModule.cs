...
public class YayZentFrameworkBackgroundWorkersHangfireModule: AbpModule
{
        /// <summary>
    /// 配置服务前的预处理
    /// </summary>
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddConventionalRegistrar(new YayZentHangfireConventionalRegistrar());
    }
