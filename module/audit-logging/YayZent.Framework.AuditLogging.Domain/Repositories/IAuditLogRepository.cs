...
namespace YayZent.Framework.AuditLogging.Domain.Repositories;

    public interface IAuditLogRepository : ISqlSugarRepository<AuditLogAggregateRoot, Guid>, ITransientDependency
    {
